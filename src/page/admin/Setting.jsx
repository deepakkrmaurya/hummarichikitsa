...
const Setting = () => {
  ...
  // State for hospital services
  // const [services, setServices] = useState([
  //   { id: 1, name: 'Emergency Care', active: true, deactivationReason: '' },
  //   { id: 2, name: 'Surgery', active: true, deactivationReason: '' },
  //   { id: 3, name: 'Maternity Ward', active: true, deactivationReason: '' },
  //   { id: 4, name: 'Pediatrics', active: true, deactivationReason: '' },
  //   { id: 5, name: 'Radiology', active: true, deactivationReason: '' },
  // ]);

  // State for doctors
  // const [doctors, setDoctors] = useState([
  //   { id: 1, name: 'Dr. Sarah Johnson', specialty: 'Emergency Medicine', serviceId: 1, active: true, deactivationReason: '' },
  //   { id: 2, name: 'Dr. Michael Chen', specialty: 'Surgery', serviceId: 2, active: true, deactivationReason: '' },
  //   { id: 3, name: 'Dr. Emily Rodriguez', specialty: 'Obstetrics', serviceId: 3, active: true, deactivationReason: '' },
  //   { id: 4, name: 'Dr. James Wilson', specialty: 'Pediatrics', serviceId: 4, active: true, deactivationReason: '' },
  //   { id: 5, name: 'Dr. Lisa Patel', specialty: 'Radiology', serviceId: 5, active: true, deactivationReason: '' },
  //   { id: 6, name: 'Dr. Robert Kim', specialty: 'Emergency Medicine', serviceId: 1, active: true, deactivationReason: '' },
  //   { id: 7, name: 'Dr. Amanda Davis', specialty: 'Surgery', serviceId: 2, active: true, deactivationReason: '' },
  // ]);
  ...
  const confirmHospitalStatusChange = async () => {
    // setHospitalInfo({
    //   ...hospitalInfo,
    //   active: !hospitalInfo.status,
    //   deactivationReason: hospitalInfo.status ? reason : ''
    // });
    ...
    if (hospitalInfo) {
      ...
      //   ...service,
      //   active: false,
      //   deactivationReason: `Hospital deactivated: ${reason}`
      // }));
  ...
  const confirmDoctorStatusChange = async () => {
    ...
    // alert("dnbm")
    // alert("db")
    const res = await axiosInstance.patch(`/doctor/${updatedDoctors[0]._id}/status`, {
      deactivationReason: reason || ""
    })
    if(res.data.success){
    ...
    <Dashboard>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex mb-6 bg-white rounded-lg border border-slate-200 p-1">
          ...
          {/* <button
            className={`flex-1 py-3 px-4 font-medium text-sm md:text-base transition-colors rounded-md flex items-center justify-center ${activeTab === 'services' ? 'bg-blue-50 text-blue-700 shadow-xs' : 'text-slate-500 hover:text-slate-700'}`}
              ...
              <table className="min-w-full divide-y divide-slate-200">
                ...
                <tbody className="bg-white divide-y divide-slate-200">
                  {filteredDoctors.map(doctor => {
                    // const service = services.find(s => s.id === doctor.serviceId);
                    // console.log(doctor)
                    return (
                      <tr key={doctor._id} className="hover:bg-slate-50/50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className={`h-8 w-8 rounded-full ${doctor.status ? 'bg-emerald-500' : 'bg-rose-500'}`}>
                            <img className=' h-10 w-10 ' src={doctor.photo} alt="" />
                          </div>
                        </td>
